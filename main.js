...
// Pour eviter l'utilisateur soumettre des champs de saisie vides
form.addEventListener("submit", (e) => {
  ...
  // collecter des données et utiliser le stockage local
  let data = [];
...
//obtenir des données à partir du stockage local
